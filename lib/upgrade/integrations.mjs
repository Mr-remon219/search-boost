import { setCodexNativeSearch } from '../codex-native.mjs'
...
async function refreshMcp(target, dryRun) {
  ...
  if (id === 'codex' || id === 'grok') {
    ...
    if (id === 'codex' && previous.includes('# SEARCH_BOOST_WEB_SEARCH_START')) {
      previous = setCodexNativeSearch(previous, true)
    }
