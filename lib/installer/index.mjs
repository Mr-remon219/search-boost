...
/** Agents whose config can pre-approve search-boost tools (`--auto-allow`). */
const AUTO_ALLOW_AGENTS = ['cursor', 'cursor-cli', 'claude', 'codex', 'grok', 'antigravity']

/** @param {string[]} rawTargets */
function autoAllowTargets(rawTargets) {
  return rawTargets.filter((id) => AUTO_ALLOW_AGENTS.includes(id))
}
