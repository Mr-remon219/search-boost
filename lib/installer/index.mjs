...
async function runKeysStep(clack, opts) {
  ...
  const configure = await clack.confirm({
    message: 'Configure API keys now? (tavily / brave / exa / anysearch; optional for free search)',
  ...
  clack.log.info('Tip: a single keyed engine works on the api layer; additional engines can broaden retrieval.')
