...
import { NET_ERROR_KINDS, NetworkPolicyError, isNetworkPolicyError, lookupBounded } from './net-policy.mjs'
...
export async function guardedFetch(url, options = {}) {
  ...
  for (let hop = 0; hop < maxHops; hop++) {
    ...
    try {
      ...
      throw new SsrfError(`fetch_page: ${err instanceof Error ? err.message : String(err)}`, NET_ERROR_KINDS.connectRefused)
    }
