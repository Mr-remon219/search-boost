 ...
 */
export async function researchRound({ query, queries, maxSources = 8, recency, layer = null, engines, runOne, signal, round = 1 }) {
  ...
  return {
    round: typeof round === 'number' && round >= 1 ? Math.floor(round) : 1,
    query,
