...
/** @param {string} existing @param {string} markerName @param {string} body */
export function upsertTomlMarker(existing, markerName, body) {
  return injectTomlSection(existing, markerName, body)
}

/** @param {string} existing @param {string} markerName */
export function removeTomlMarker(existing, markerName) {
  return removeTomlSection(existing, markerName)
}
