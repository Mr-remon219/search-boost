...
export function checkClaudePermissionConfig(ctx = {}) {
  ...
  const partialArtifacts = hasSettings
    && (hasAllow || hasSkill || hasInject || claudePriorInstallArtifacts(ctx.homeDir ?? undefined).mcpConfigured)
